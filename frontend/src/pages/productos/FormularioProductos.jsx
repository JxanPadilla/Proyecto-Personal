            ...
            <div className=" w-full justify-center h-5/6 items-center mt-24">
                ...
                <div className="w-full">
                    <h1 className="font-bold text-6xl uppercase text-center w-full mx-auto">
                        Registra tus <span className="text-blue-500">productos</span>
                    </h1>
                    <form
                    ...
                    >
                        ...
                        <input
                            type="submit"
                            value="Guardar"
                            className="uppercase bg-blue-400 text-white p-2 rounded-md w-full cursor-pointer hover:bg-blue-600"
                        />
                    </form>
                </div>
            </div>
