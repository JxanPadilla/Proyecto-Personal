                ...
                <div className="w-full py-5 flex items-center h-full mt-24">
                    ...
                    >
                        <button
                            ...
                            className="text-red-600 font-bold bg-white text-xl p-4 flex float-right hover:scale-110 "
                        >
                            X
                        </button>
                        <h1 className="font-bold text-6xl uppercase text-center w-full mx-auto mt-24">
                            Edita tu <span className="text-blue-400">producto</span>
                        </h1>
                        ...
                        <input
                            type="submit"
                            value="Guardar"
                            className="font-medium uppercase bg-blue-400 text-white p-2 rounded-md w-full cursor-pointer hover:bg-blue-600"
                        />
                    </form>
                </div>
            </div>
