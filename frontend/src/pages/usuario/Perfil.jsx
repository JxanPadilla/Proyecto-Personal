                    ...
                    <div className="mx-auto my-5">
                        <button className="hover:scale-110 transition-all">
                            ...
                            <Link
                                ...
                                className="uppercase bg-white text-black p-2 w-full cursor-pointer font-medium hover:border-b-blue-500 hover:border-b-2 hover:scale-110 transition-all mt-10 "
                            >
                                 Cambiar Contraseña 
                            </Link>
                        </button>
