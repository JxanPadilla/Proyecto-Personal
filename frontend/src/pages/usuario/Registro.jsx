...
import imagenRegistro from '../../assets/registro.png'
    ...
    return (
        <div className='flex w-full'>
            <div className='flex flex-col justify-center items-center lg:w-2/4 mr-10 md:flex-row '>
                ...
                <div>
                    <h1 className='font-bold text-5xl uppercase text-center md:w-2/3 mx-auto '>Registrate y disfruta de los <span className='text-blue-400'>productos</span></h1>
                        { msg && <Alerta 
                                alerta={alerta}
                            />
                        }  
                    ...
                    >
                        ...
                        <input type="submit" value="Crear Cuenta" className='uppercase bg-blue-400 text-white p-2 rounded-md w-full hover:bg-blue-600' />

                        <div className='flex justify-between px-4 mt-5 text-slate-500 '>
                            <Link to="/" className='hover:text-blue-400'>Ya tengo cuenta.</Link>
                            <Link to="/olvide-password" className="hover:text-blue-400" >Olvide mi password.</Link>
                        </div>
                    </form>
                </div>
            </div>
            <div className='h-6 w-70 lg:w-70'>
