      ...
      <div className=" w-full h-5/6 ">
        <div className="w-full flex flex-col mt-24 overflow-hidden">
          <h1 className="font-bold text-5xl uppercase text-center w-full mx-auto">
            Lista de tus <span className="text-blue-500">pedidos</span>
          </h1>
            ...
            <div className='my-5 '>
              ...
              <table className='table-fixed mx-auto w-full'>
                <thead>
                  <tr>
                    <th className='w-24'>
                      <span className='text-blue-500 uppercase text-xl'>ID</span>
                    </th>
                    <th className='w-24'>
                      <span className='text-blue-500 uppercase text-xl'>Cliente</span>
                    </th>
                    <th className='w-24'>
                      <span className='text-blue-500 uppercase text-xl'>Fecha del Pedido</span>
                    </th>
                    <th className='w-24'>
                      <span className='text-blue-500 uppercase text-xl'>Valor Total</span>
                    </th>
                    <th className='w-24 m'>
                      <span className='text-blue-500 uppercase text-xl'>Estado</span>
                    </th>
                  </tr>
                </thead>
                  {
