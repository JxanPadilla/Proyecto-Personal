...
const AsideVenta = ({ verAside, setAsideVentas }) => {
  ...
  return (
    ...
    >
      <div className="overflow-y-scroll mb-3">
        <div className="flex items-center">
          <h1 className="font-bold text-3xl uppercase text-center md:w-2/3 mx-auto">
            Carrito de <span className="text-blue-500">compras</span>
          </h1>
          <button
            onClick={(e) => setAsideVentas(false)}
            className="text-red-600 font-bold bg-slate-200 text-xl mr-6 flex float-right hover:scale-110 "
          >
            X
          </button>
        </div>
        <div className="my-5 ">
          ...
          <p className="w-full text-center font-bold text-xl  mt-2 uppercase text-blue-600 flex justify-between px-4">
            {" "}
            <i>SubTotal : </i>{" "}
      ...
      <button
        type="button"
        className="flex bg-blue-500 text-white rounded-lg uppercase font-medium hover:bg-blue-600 transition-colors w-full"
      >
        <Link 
          to="/venta" 
      ...
      <button
        type="button"
        className="flex bg-blue-500 text-white rounded-lg uppercase font-medium hover:bg-blue-600 transition-colors w-full mt-2"
