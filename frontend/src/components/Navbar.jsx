...
const Navbar = ({ texto, ruta, id, perfil, verVenta, verCompras }) => {
  ...
  return (
    <nav className="shadow bg-slate-200 mb-10 flex fixed z-10 w-full top-0 ">
        ...
        <div className="flex gap-3">
          {!verVenta && (
            <button type="button" className="hover:scale-110 text-black p-2  flex items-center cursor-pointer font-medium hover:border-b-blue-500 hover:border-b-2 transition-all" onClick={mostrarAside}>
              <span className="uppercase bg-blue-400 text-white p-2 w-full hover:bg-blue-600 rounded-full px-2 top-10">{articulosCarritos.length}</span>
          ...
          <button
            type="button"
            className="uppercase bg-blue-500 text-white p-2 rounded-md  hover:bg-blue-600"
          >
            <Link 
              to={"/"} 
      ...
      <div className="md:hidden w-full flex justify-between px-5 items-center overflow-hidden z-10">
        ...
        {ver && (
          <div className="flex flex-col gap-3 absolute top-20 left-0 w-full bg-slate-200 p-4 justify-between">
            ...
            <button
              type="button"
              className="bg-sky-700 text-black rounded-lg uppercase font-medium hover:bg-sky-500 transition-colors"
            >
              <Link to={"/"} 
